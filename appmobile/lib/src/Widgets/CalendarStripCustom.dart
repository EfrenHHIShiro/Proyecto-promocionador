...
class CalendarStripCustom extends StatefulWidget {
  CalendarStripCustom({Key key}) : super(key: key);
...
class _CalendarStripCustomState extends State<CalendarStripCustom> {
  ...
  DateTime selectedDate = DateTime.now().subtract(Duration(days: 15));
    ...
    return Container(
      ...
      child: CalendarStrip(
        ...
        containerDecoration: BoxDecoration(
          ...
          boxShadow: <BoxShadow>[
            BoxShadow(
                color: Colors.black26, blurRadius: 5.0, offset: Offset(0.0, 6))
          ],
